...
router.get("/trainer-account/:slug", adminController.trainerDetailAction);
...
router.get("/staff-account/:slug", adminController.staffDetailAction);
...
router.get("/admin-accounts/search", adminController.searchAdminAccounts);
router.get("/admin-account/:slug", adminController.adminDetailAction);
router.get("/admin-accounts/passwords/set_default", adminController.setDefaultPassA);
router.post("/admin-accounts/update", img.upload(destination), img.resize(width, height), adminController.updateAdminAccount);
router.get("/admin-accounts/edit", adminController.editAdminAccount);
router.post("/admin-accounts/store", img.upload(destination), img.resize(width, height), adminController.storeAdminAccount);
router.get("/admin-accounts/delete", adminController.deleteAdminAccount);
router.get("/admin-accounts", adminController.showAdminAccounts);
